                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" action="createUser" method="post">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Name is required">
                            <input class="input100" type="text" name="userBean.userName" placeholder="Your Name" required="required">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                            <input class="input100" type="text"  onkeyup="ValidateEmailID(this);" name="userBean.useremailId" placeholder="Your Email" required="required">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Password is required" required="required">
                            <input class="input100" onkeyup="validatePass(this);" type="password" name="userBean.userpassword" placeholder="Password" required="required" rel="txtTooltip" title="Passwrod must have at least one number /at least one special character" data-toggle="tooltip" data-placement="top">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Repeat Password is required" required="required">
                            <input class="input100" onkeyup="validatePassword(this);" type="password" name="userBean.userRepeatPassword" placeholder="Repeat Password" required="required">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="fa fa-lock" aria-hidden="true"></i>
                            </span>
