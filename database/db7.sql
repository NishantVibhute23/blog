...
DROP TABLE IF EXISTS `expert_area`;
...
/*Data for the table `expert_area` */

insert  into `expert_area`(`id`,`area_name`,`desc`,`color`,`isDeleted`) values 
(1,'Fitness','Here you can ask any question to our expert on fitness',1,0),
(2,'Study1','Here you can ask any question to our expert on fitnessasdf',2,1),
(3,'Research','Here you can ask any question to our expert on fitness',3,0),
(4,'Sport','Here you can ask any question to our expert on fitness',4,0),
(5,'Science','Here you can ask any question to our expert on fitness',5,0),
(6,'Study','Here you can ask any question to our expert on fitness',6,0),
(7,'Research','a',7,0),
(8,'Study','Here you can ask any question to our expert on fitness',8,1);

/*Table structure for table `expert_email` */

DROP TABLE IF EXISTS `expert_email`;

CREATE TABLE `expert_email` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `area_id` (`area_id`),
  CONSTRAINT `expert_email_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `expert_area` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

/*Data for the table `expert_email` */

insert  into `expert_email`(`id`,`name`,`email_id`,`area_id`,`isDeleted`) values 
(1,'Guruprasad Tiwari','nishantvibhute92@gmail.com',1,0),
(2,'Nishant Vibhute','nishantvibhute92@gmail.com',1,0),
(3,'Nishant Vibhute','nishantvibhute92@gmail.com',3,0),
(4,'Nishant Vibhute','nishantvibhute92@gmail.com',4,0),
(5,'Nishant Vibhute','nishantvibhute92@gmail.com',5,0),
(6,'Nishant Vibhute','nishantvibhute92@gmail.com',6,0),
(7,'Nishant Vibhute','nishantvibhute92@gmail.com',7,0),
(8,'Nishant Vibhute','nishantvibhute92@gmail.com',8,0);

/*Table structure for table `expertquestionmail` */

DROP TABLE IF EXISTS `expertquestionmail`;

CREATE TABLE `expertquestionmail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `expert_id` int(11) DEFAULT NULL,
  `question_id` int(11) DEFAULT NULL,
  `answer` text,
  `isAnswered` tinyint(4) DEFAULT '0',
  `guid` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `expert_id` (`expert_id`),
  KEY `question_id` (`question_id`),
  CONSTRAINT `expertquestionmail_ibfk_2` FOREIGN KEY (`question_id`) REFERENCES `userexpertquestion` (`id`),
  CONSTRAINT `expertquestionmail_ibfk_1` FOREIGN KEY (`expert_id`) REFERENCES `expert_email` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Data for the table `expertquestionmail` */

insert  into `expertquestionmail`(`id`,`expert_id`,`question_id`,`answer`,`isAnswered`,`guid`) values 
(1,1,1,NULL,0,'5d85cb5b-82b0-11e9-9679-74d43587dbab'),
(2,2,1,NULL,0,'5d865b3e-82b0-11e9-9679-74d43587dbab'),
(3,1,2,NULL,0,'92ba5df8-82b0-11e9-9679-74d43587dbab'),
(4,2,2,NULL,0,'92baf876-82b0-11e9-9679-74d43587dbab'),
(5,1,3,'None',1,''),
(6,2,3,'Delhi (/?d?li/, Hindi pronunciation: [d?lli?] Dill?, Punjabi pronunciation: [d?lli?] Dill?, Urdu pronunciation: [d?hli?] Dehl?), officially the National Capital Territory of Delhi (NCT), is a city and a union territory of India containing New Delhi, the capital of India.[17][18] It is bordered by Haryana on three sides and by Uttar Pradesh to the east. The NCT covers an area of 1,484 square kilometres (573 sq mi). According to the 2011 census, Delhi\'s city proper population was over 11 million,[7] the second-highest in India after Mumbai,[19] while the whole NCT\'s population was about 16.8 million.[8] Delhi\'s urban area is now considered to extend beyond the NCT boundaries and include the neighboring satellite cities of Faridabad, Gurgaon, Sonipat, Ghaziabad and Noida in an area now called Central National Capital Region (CNCR) and had an estimated 2016 population of over 26 million people, making it the world\'s third-largest urban area according to United Nations.[9] As of 2016, recent estimates of the metro economy of its urban area have ranked Delhi either the most or second-most productive metro area of India.[13][12][20][14] Delhi is the second-wealthiest city in India after Mumbai, with a nominal economy of $110 billion for the entire Union Territory,[21] and is home to 18 billionaires and 23,000 millionaires.[22]\r\n\r\nDelhi has been continuously inhabited since the 6th century BCE.[23] Through most of its history, Delhi has served as a capital of various kingdoms and empires. It has been captured, ransacked and rebuilt several times, particularly during the medieval period, and modern Delhi is a cluster of a number of cities spread across the metropolitan region.',1,''),
(7,1,4,'Mumbai',1,''),
(8,2,4,NULL,0,'9b549068-82ba-11e9-9679-74d43587dbab');

/*Table structure for table `m_color_code` */

DROP TABLE IF EXISTS `m_color_code`;

CREATE TABLE `m_color_code` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `m_color_code` */

insert  into `m_color_code`(`id`,`color`,`code1`,`code2`) values 
(1,'blue','#B8D5D5','#528B8B'),
(2,'red','#BFBCFF','#9B95FF'),
(3,'green','#047C72','#047C72'),
(4,'violet','#441F6C','#441F6C'),
(5,'pink','#E63C7B','#E63C7B'),
(6,'burgundy','#6E101C','#6E101C'),
(7,'saphire blue','#232556','#232556'),
(8,'Dark green','#0B7735','#0B7735');
...
/*Table structure for table `userexpertquestion` */

DROP TABLE IF EXISTS `userexpertquestion`;

CREATE TABLE `userexpertquestion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `question` text,
  `user_id` int(11) DEFAULT NULL,
  `area_id` int(11) DEFAULT NULL,
...
/*Data for the table `userexpertquestion` */

insert  into `userexpertquestion`(`id`,`question`,`user_id`,`area_id`) values 
(1,'what is the capital of Maharashtra?',3,1),
(2,'what is the capital of Delhi?',3,1),
(3,'what is the capital of Delhi?',3,1),
(4,'what is the capital of Maharashtra?',3,1);
...
(1,'root','ab@gmail.com','root',1,'2019-03-16 11:23:23',1,'2019-05-30 12:23:52','2019-05-30 12:21:17'),
(2,'Guru','g@gmail.com','root',2,'2019-05-10 11:00:04',0,'2019-05-08 15:41:58','2019-05-09 15:42:01'),
(3,'Nishant','ab1@gmail.com','root',2,'2019-05-10 14:41:00',1,'2019-05-30 14:34:25','2019-05-28 16:11:09'),
(4,'ab2','ab2@gmail.com','root',2,'2019-05-10 14:41:45',0,'2019-05-10 14:42:09','2019-05-10 14:42:26');

/* Procedure structure for procedure `addNewExpert` */

/*!50003 DROP PROCEDURE IF EXISTS  `addNewExpert` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `addNewExpert`(name_in varchar(255),email_in varchar(255),area_id_in int)
BEGIN
	 insert into `expert_email`(`name`,`email_id`,`area_id`)
	 values(name_in,email_in,area_id_in);
	END */$$
DELIMITER ;

/* Procedure structure for procedure `addNewExpertArea` */

/*!50003 DROP PROCEDURE IF EXISTS  `addNewExpertArea` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `addNewExpertArea`(area_name_in varchar(255),desc_in text)
BEGIN
		declare colorid int;
		
			
			insert into `expert_area`(`area_name`,`desc`)
			values(area_name_in,desc_in);
...
/* Procedure structure for procedure `deleteArea` */

/*!50003 DROP PROCEDURE IF EXISTS  `deleteArea` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `deleteArea`(area_id_in int)
BEGIN
		update `expert_area`
		set `isDeleted` = 1
		where `id` = area_id_in;
...
/* Procedure structure for procedure `editArea` */

/*!50003 DROP PROCEDURE IF EXISTS  `editArea` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `editArea`(area_id_in int,area_name_in varchar(255),desc_in text)
BEGIN
	
		update `expert_area`
		set `area_name` = area_name_in,
			`desc` = desc_in
			where `id` = area_id_in;
...
/* Procedure structure for procedure `getAreaDetail` */

/*!50003 DROP PROCEDURE IF EXISTS  `getAreaDetail` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getAreaDetail`(area_id int)
BEGIN
	select `id`,`area_name`,`desc`,`isDeleted`
	from `expert_area`
	where `id` = area_id;
	END */$$
DELIMITER ;

/* Procedure structure for procedure `getExpertAreas` */

/*!50003 DROP PROCEDURE IF EXISTS  `getExpertAreas` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getExpertAreas`()
BEGIN
	select e.`id`,e.`area_name`,e.`desc`,mc.`code1`,mc.`code2`
	from `expert_area` e join `m_color_code` mc
	on mc.`id` = e.`color`
	where e.`isDeleted`=0;
...
/* Procedure structure for procedure `getExpertiesGuidOfQuestion` */

/*!50003 DROP PROCEDURE IF EXISTS  `getExpertiesGuidOfQuestion` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getExpertiesGuidOfQuestion`(question_id int)
BEGIN
		select ee.`name`,ee.`email_id`,eqm.`guid`
		from `expertquestionmail` eqm join `expert_email` ee
		on ee.`id` = eqm.`expert_id`
		where eqm.`question_id`=question_id;
	END */$$
DELIMITER ;

/* Procedure structure for procedure `getExpertiesOfArea` */

/*!50003 DROP PROCEDURE IF EXISTS  `getExpertiesOfArea` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getExpertiesOfArea`(area_id_in int)
BEGIN
	select `id`,`name`,`email_id`
	from `expert_email`
	where `isDeleted` = 0 and `area_id` = area_id_in;
	END */$$
DELIMITER ;

/* Procedure structure for procedure `getExpertQestionAnswer` */

/*!50003 DROP PROCEDURE IF EXISTS  `getExpertQestionAnswer` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getExpertQestionAnswer`(question_id_in int)
BEGIN
	select `answer`
	from `expertquestionmail`
	where `isAnswered` = 1 and `question_id` = question_id_in;
...
/* Procedure structure for procedure `getQuestionBasedOnGuid` */

/*!50003 DROP PROCEDURE IF EXISTS  `getQuestionBasedOnGuid` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getQuestionBasedOnGuid`(guid_in varchar(50))
BEGIN

		select eqm.`id`,ueq.`question`
		from `expertquestionmail` eqm join `userexpertquestion` ueq
		on ueq.`id` = eqm.`question_id`
		where eqm.`guid` = guid_in and eqm.`isAnswered`=0;
...
/* Procedure structure for procedure `getUserExpertQuestions` */

/*!50003 DROP PROCEDURE IF EXISTS  `getUserExpertQuestions` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `getUserExpertQuestions`(user_id_in int,area_id_in int)
BEGIN
		select `id`,`question`
		from `userexpertquestion`
		where `user_id`= user_id_in and `area_id`=area_id_in
		order by id desc;
	END */$$
DELIMITER ;
...
/* Procedure structure for procedure `insertExpertQusetion` */

/*!50003 DROP PROCEDURE IF EXISTS  `insertExpertQusetion` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `insertExpertQusetion`(`question_in` text,`user_id_in` int,`area_id_in` int)
BEGIN
		declare qid int;
		...
		insert into `userexpertquestion`(`question`,`user_id`,`area_id`)
		values(`question_in`, `user_id_in`, `area_id_in`);
		
		select last_insert_id() into qid;
		
		select count(id) INTO n from `expert_email` where `area_id` = area_id_in;
		
		SET i=0;
		
		WHILE i<n DO 
		
			  SELECT (`id`)  into eId FROM `expert_email` where `area_id` = area_id_in LIMIT i,1;
		
			  INSERT INTO `expertquestionmail`(`expert_id`,`question_id`,`guid`) 
			  values(eId,qid,UUID());
...
/* Procedure structure for procedure `submitExpertAnswer` */

/*!50003 DROP PROCEDURE IF EXISTS  `submitExpertAnswer` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `submitExpertAnswer`(expertquestion_id_in int,answer_in text)
BEGIN
	
		update `expertquestionmail`
		set `answer` = answer_in ,
			`guid` = "",
			`isAnswered`=1
		where `id` = expertquestion_id_in;
